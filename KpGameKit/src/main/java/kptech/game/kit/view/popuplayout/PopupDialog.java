...
public class PopupDialog extends Dialog{
    ...
    private void configWindowAnimations(Window window){
        switch(mGravity){
            case Gravity.LEFT:
                window.setWindowAnimations(R.style.KpLeftDialogAnimation);
                break;
            case Gravity.RIGHT:
                window.setWindowAnimations(R.style.KpRightDialogAnimation);
                break;
            case Gravity.CENTER:
                //从中心弹出使用默认动画，不作额外处理
                break;
            case Gravity.TOP:
                window.setWindowAnimations(R.style.KpTopDialogAnimation);
                break;
            case Gravity.BOTTOM:
            default:
                window.setWindowAnimations(R.style.KpBottomDialogAnimation);
                break;
        }
    }
