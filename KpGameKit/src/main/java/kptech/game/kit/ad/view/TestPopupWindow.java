...
public class TestPopupWindow extends BasePopupWindowWithMask {
    ...
    public TestPopupWindow(Context context, int[] mIds,  ZadFeedDataAdBean adBean) {
        super(context);
        mActivity = context;
        this.mIds = mIds;
        this.adBean = adBean;
...
//        initListener();
    ...
    protected View initContentView() {
        contentView = LayoutInflater.from(context).inflate(R.layout.ad_popup_feed, null, false);
        findFeedView();
    ...
    protected int initWidth() {
        return (int) (DensityUtil.getScreenWidth(context));
    }
    ...
    private LinearLayout zmtItemAdRelativeLayout1;
    ...
    private void findFeedView() {
        ...
        zmtItemAdRelativeLayout1 = (LinearLayout) rootView.findViewById(R.id.zmt_item_ad_RelativeLayout1);
