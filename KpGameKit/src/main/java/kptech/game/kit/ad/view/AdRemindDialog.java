...
//    public static void show(final Activity activity , IAdCallback callback){
...
//            if (mCallback!=null){
//                mCallback.onAdCallback("success", 1);
//            }
//        }
//    };
//
...
//            if (!mRewardVerify){
//                if (mCallback!=null){
//                    mCallback.onAdCallback(" ad closed ", 0);
//                }
//                return;
//            }
//            //进入游戏
